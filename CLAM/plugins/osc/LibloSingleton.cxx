...
bool CLAM::LibloSingleton::IsPathRegistered(unsigned port, const std::string & path, const std::string & typespec) const
{
...
bool CLAM::LibloSingleton::RemoveRegisteredPath(unsigned port, const std::string & path, const std::string & typespec)
{
