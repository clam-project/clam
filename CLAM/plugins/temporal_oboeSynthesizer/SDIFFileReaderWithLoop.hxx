#ifndef _SDIFFileReaderWithLoop_
...
* \since CLAM v1.1
*/
class SDIFFileReaderWithLoop : public SDIFFileReaderWithBuffer
{
public:
	/**
	...
	*/
	SDIFFileReaderWithLoop(const SDIFInConfig& argSDIFInConfig);
	
	~SDIFFileReaderWithLoop();
