...
public:
		...
		void Connect( RefType thisRef, PtrMember pMember, Slot& slot )
	{
		...
		AddCallback( c.GetID(), &slot, CBL::makeFunctor( (CBL::Functor3<ParmType1,ParmType2,ParmType3>*)0, *thisRef, pMember ) );
		...
		void Connect( PtrFunction pMember, Slot& slot )
	{
		...
		AddCallback( c.GetID(), &slot, CBL::makeFunctor( (CBL::Functor3<ParmType1,ParmType2,ParmType3>*)0, pMember ) );
