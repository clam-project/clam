...
template < typename ParmType1, template ParmType2, typename ParmType3 >
...
public:
		...
		void Connect( RefType thisRef, PtrMember pMember, Slot& slot )
	{
		...
		mSuper.AddCallback( c.GetID(), &slot, CBL::makeFunctor( (CBL::Functor3<ParmType1,ParmType2,ParmType3>*)0, *thisRef, pMember ) );
		...
		void Connect( PtrFunction pMember, Slot& slot )
	{
		...
		mSuper.AddCallback( s.GetID(), &slot, CBL::makeFunctor( (CBL::Functor3<ParmType1, ParmType2, ParmType3>*)0, pMember ) );
