...
#ifndef __GLPHASESPRENDERER__
#define __GLPHASESPRENDERER__
...
namespace CLAMGUI
{
	...
	public:
		...
		GLPhaseSpRenderer( unsigned char r = 0, unsigned char g = 255, unsigned char b = 0 )
