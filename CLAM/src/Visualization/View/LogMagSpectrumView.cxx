...
namespace CLAMGUI
{
		...
		LogMagSpectrumView::~LogMagSpectrumView()
		{
		}

		void LogMagSpectrumView::TrivialCaseConversion()
		{
		...
		void LogMagSpectrumView::TranslateSpectralData()
		{
		...
		bool LogMagSpectrumView::Refresh()
		{
				if ( !mObserved )
						return false;
