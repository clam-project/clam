...
#ifndef __FL_PLAYABLE_AUDIO__
#define __FL_PLAYABLE_AUDIO__
...
namespace CLAMVM
{
	...
	class Fl_Playable_Audio : public Fl_Window, public AudioPresentation, public PlayablePresentation
	{
	private:
		Fl_X_Axis*              mXAxis;
		Fl_Y_Axis*              mYAxis;
	...
	public:
		Fl_Playable_Audio( int X, int Y, int W, int H, const char* label = 0 );
		~Fl_Playable_Audio();
