...
namespace CLAMVM
{
	Fl_Playable_Audio::Fl_Playable_Audio( int X, int Y, int W, int H, const char* label )
		: Fl_Window( X, Y, W, H, label )
	{
		...
		mDisplay = new Fl_Gl_Single_Display( 0, 0, W-50, H-40 );
		resizable( mDisplay );
	...
	Fl_Playable_Audio::~Fl_Playable_Audio( )
	{
	}

	void Fl_Playable_Audio::OnNewAudio( const DataArray& array, TTime begin, TTime end, TData srate )
	{
	...
	void Fl_Playable_Audio::Show()
	{
		show();
	}

	void Fl_Playable_Audio::Hide()
	{
		hide();
	}
}
