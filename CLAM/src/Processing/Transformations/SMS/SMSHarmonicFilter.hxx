...
#ifndef _SMSHarmonicFilter_
#define _SMSHarmonicFilter_
...
namespace CLAM{
	...
	class SMSHarmonicFilter: public SMSTransformationTmpl<SpectralPeakArray>
	{
		
		/** This method returns the name of the object
		 *  @return Char pointer with the name of object
		 */
		const char *GetClassName() const {return "SMSHarmonicFilter";}
	...
	public:
		...
		*/
		SMSHarmonicFilter(const SMSTransformationConfig &c):SMSTransformationTmpl<SpectralPeakArray>(c)
		{
		}
