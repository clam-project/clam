...
bool SpectralAnalysis::Do(const Audio& in,Spectrum& outSp)
{
	...
	in.GetAudioChunk(0,in.GetSize() ,mAudioFrame,false);
...
{
	/** @warning: before, Audio Frame was supposed to just contain hop-size samples, now it is
	supposed to hold all the window-size samples */
