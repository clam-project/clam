...
# ADD LINK32 /libpath:"..\..\..\..\portmidi\lib" /libpath:"..\..\..\..\dxsdk\lib" dsound.lib dxerr8.lib portmidi.lib porttime.lib winmm.lib /nologo /subsystem:console /machine:I386
...
# ADD LINK32 /libpath:"..\..\..\..\portmidi\lib" /libpath:"..\..\..\..\dxsdk\lib" dsound.lib dxerr8.lib portmidid.lib porttimed.lib winmm.lib /nologo /subsystem:console /machine:I386
...
"buildstamp" : $(SOURCE) "$(INTDIR)" "MIDISynthesizer.dsp"
	srcdeps.exe settings.cfg MIDISynthesizer.dsp
