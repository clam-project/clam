AnalysisSynthesis is a CLAM usage example. As a final application it is still in an
...
or the other is to compile the file AnalysisSynthesisGUI.cxx (if you want GUI) or 
AnalysisSynthesis.cxx (if you don't).

The only externals you need for compiling the AnalysisSynthesis app are Xerces, 
