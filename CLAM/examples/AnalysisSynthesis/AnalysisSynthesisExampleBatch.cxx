...
class AnalysisSynthesisExampleBatch:public AnalysisSynthesisExampleBase
{
public:
...
void AnalysisSynthesisExampleBatch::Run(void)
{
	bool finish = false;
	while(!finish){
		std::cout <<"\n" << "\n";
...
{
	try{
		AnalysisSynthesisExampleBatch example;
		example.Run();
	}
	catch(Err error)
	{
