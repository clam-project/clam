#ifndef _SPECTRUM_SUBTRACT_H_
#define _SPECTRUM_SUBTRACT_H_
...
namespace MTG {
	...
	class SpectrumSubtractConfig: public ProcessingObjectConfig
	{
	public:
		REG_NUM_ATTR_USING_INTERFACE (SpectrumSubtractConfig, 1,ProcessingObjectConfig);
 ...
 * BPFs, into a new BPF.  */
	class SpectrumSubtract: public ProcessingObject {
		SpectrumSubtractConfig mConfig;
		 ...
		 * @throw
		 * bad_cast exception when the argument is not an SpectrumSubtractConfig
		 * object.
		 */
	...
	public:
		...
		SpectrumSubtract(const SpectrumSubtractConfig &c);
