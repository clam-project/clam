...
public: // TestFixture interface
	...
	//	CLAM::XMLStorage::Dump( mConfig, "Config", mPathToTestData + "/SMSAnalisisConfigUsed.xml");
		
		CLAM::XMLStorage::Restore( mConfig, mPathToTestData + "/SMSAnalisisConfigUsed.xml");
