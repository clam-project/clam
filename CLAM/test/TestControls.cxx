...
CPPUNIT_TEST_SUITE_REGISTRATION( ControlTest );

class ControlTest : public CppUnit::TestFixture
{
	CPPUNIT_TEST_SUITE( ControlTest );
	CPPUNIT_TEST( TestBasics);
	CPPUNIT_TEST( TestDynamicControls);
	CPPUNIT_TEST( TestPublishedControls);
