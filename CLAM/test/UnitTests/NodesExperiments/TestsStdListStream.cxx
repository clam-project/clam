...
class TestsStdListStream ;
CPPUNIT_TEST_SUITE_REGISTRATION( TestsStdListStream );

class TestsStdListStream : public CppUnit::TestFixture
{
public:
	CPPUNIT_TEST_SUITE( TestsStdListStream );
	...
	{
		WritingRegion<int,StdList> writer;
	...
	{
		WritingRegion<int,StdList>::ProperReadingRegion reader;
	...
	void testReadingRegion_canConsume_when2ReadingRegionsBehindAndNonOverlap()
	{
		...
		// W:     ^
		WritingRegion<int,StdList> writer;
		WritingRegion<int,StdList>::ProperReadingRegion reader1;
		WritingRegion<int,StdList>::ProperReadingRegion reader2;
	...
	{
		WritingRegion<char,StdList> writer;
		WritingRegion<char,StdList>::ProperReadingRegion reader;
		writer.linkRegions( reader );
