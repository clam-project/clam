...
class TestsStdVectorStream ;
CPPUNIT_TEST_SUITE_REGISTRATION( TestsStdVectorStream );

class TestsStdVectorStream : public CppUnit::TestFixture
{
public:
	CPPUNIT_TEST_SUITE( TestsStdVectorStream );
	...
	{
		WritingRegion<int,StdVector> writer;
	...
	{
		WritingRegion<int,StdVector>::ProperReadingRegion reader;
	...
	void testReadingRegion_canConsume_when2ReadingRegionsBehindAndNonOverlap()
	{
		...
		// W:     ^
		WritingRegion<int,StdVector> writer;
		WritingRegion<int,StdVector>::ProperReadingRegion reader1;
		WritingRegion<int,StdVector>::ProperReadingRegion reader2;
	...
	{
		WritingRegion<char,StdVector> writer;
		WritingRegion<char,StdVector>::ProperReadingRegion reader;
		writer.linkRegions( reader );
