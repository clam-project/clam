...
namespace CLAMVM
{
	const char* SMSTimeStretchConfigurator::mHelpText = "<html><body><p>Here should go a nice text describing what does the SMS Time Stretching transformation do</p></body></html>";
